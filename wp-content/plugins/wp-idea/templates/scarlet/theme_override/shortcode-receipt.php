...
?>
<div class="row">
<div class="col-sm-8 content_koszyk">
<table id="edd_purchase_receipt" class="podsumowanie_koszyk">
	<thead>
	...
	<tbody>
		...
		<tr>
			<td><strong><?php echo Translator_Static_Helper::translate('receipt.fees'); ?>:</strong></td>
			<td>
...
<?php if ( filter_var( $edd_receipt_args['products'], FILTER_VALIDATE_BOOLEAN ) ) : ?>
	...
	<table id="edd_purchase_receipt_products" class="podsumowanie_koszyk">
		<thead>
