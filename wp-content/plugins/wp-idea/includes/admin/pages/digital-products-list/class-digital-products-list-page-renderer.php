...
class Digital_Products_List_Page_Renderer extends Abstract_Page_Renderer
{
    ...
    {
        return $this->view_provider->get_admin(Admin_View_Names::DIGITAL_PRODUCTS, [
            'page_title' => $this->translator->translate('digital_products_list.page_title'),
