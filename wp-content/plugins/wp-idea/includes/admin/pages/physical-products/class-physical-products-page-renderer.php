...
class Physical_Products_Page_Renderer extends Abstract_Page_Renderer
{
    private Interface_View_Provider $view_provider;
    private Interface_Translator $translator;
    private Interface_Url_Generator $url_generator;
    private Dynamic_Tables_Module $dynamic_tables_module;
    private Physical_Products_Table_Config_Provider $config_provider;
    ...
    public function __construct(
        ...
        Physical_Products_Table_Config_Provider $config_provider
    )
    {
    ...
    public function get_rendered_page(): string
    {
        ...
        return $this->view_provider->get_admin(Admin_View_Names::PHYSICAL_PRODUCTS, [
            'table' => $this->prepare_table(),
            'page_title' => $this->translator->translate('physical_products.page_title')
        ]);
    }
    ...
    public function get_page_url(): string
    {
        return $this->url_generator->generate_admin_page_url('admin.php', [
            'page' => Admin_Menu_Item_Slug::PHYSICAL_PRODUCTS
        ]);
    }
}