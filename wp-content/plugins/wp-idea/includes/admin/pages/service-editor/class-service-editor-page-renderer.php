...
class Service_Editor_Page_Renderer extends Abstract_Page_Renderer
{
    public const SERVICE_ID_QUERY_ARG_NAME = 'edit_service_id';
    ...
    public function get_rendered_page(): string
    {
        ...
        return $this->view_provider->get_admin(Admin_View_Names::PRODUCTS_EDITOR, [
            'page_title' => $this->translator->translate('service_editor.page_title'),
            'sections' => $this->get_sections(),
            'get_tab_ajax_url' => $this->prepare_get_tab_ajax_url(),
            'preview_text' => $this->translator->translate('service_editor.preview_button'),
    ...
    {
        $id = $this->current_request->get_query_arg(self::SERVICE_ID_QUERY_ARG_NAME);
    ...
    private function prepare_get_tab_ajax_url(): string
    {
        return $this->url_generator->generate(Admin_Settings_Fields_Ajax_Controller::class, 'get_tab_content', [
            ...
            self::SERVICE_ID_QUERY_ARG_NAME => $this->get_product_id()
        ]);
    }
