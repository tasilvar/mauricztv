...
namespace bpmj\wpidea\admin\pages\service_editor\infrastructure\services;
...
class Services_Settings_Fields_Service implements Interface_Settings_Fields_Service
{
    ...
    public function update_field(Abstract_Setting_Field $field): void
    {
        ...
        $service_dto = $this->create_service_dto_from_product_dto($product_dto);
        ...
        if(property_exists($service_dto, $field_name)) {
            $old_value = $service_dto->$field_name;
            $service_dto->$field_name = $field_value;
        }

        $this->services_app_service->save_service($product_dto, $service_dto);

        $this->product_events->emit_services_field_value_updated_event(
            $field,
            $old_value,
            $field->get_value(),
            $this->id->to_int()
    ...
    private function create_service_dto_from_product_dto(Product_DTO $product_dto): Service_DTO
    {
        $service_dto = new Service_DTO();
