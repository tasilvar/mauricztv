...
class Affiliate_Page_Renderer extends Abstract_Page_Renderer
{
    ...
    {
        return $this->view_provider->get_admin('/pages/affiliate-program/index', [
            'page_title' => $this->translator->translate('affiliate_program.page_title'),
