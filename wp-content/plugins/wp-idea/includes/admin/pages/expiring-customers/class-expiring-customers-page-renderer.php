...
class Expiring_Customers_Page_Renderer extends Abstract_Page_Renderer
{
    ...
    {
        return $this->view_provider->get_admin(Admin_View_Names::EXPIRING_CUSTOMERS_PAGE, [
            'page_title' => $this->translator->translate('expiring_customers.page_title'),
