...
class Discounts_Page_Renderer extends Abstract_Page_Renderer
{
    ...
    {
        return $this->view_provider->get_admin(Admin_View_Names::DISCOUNT_CODE_LIST_PAGE, [
            'page_title' => $this->translator->translate('discount_codes.page_title'),
