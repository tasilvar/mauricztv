...
<section class='step-one animated fadeInUp'
         data-next-step-label="<?= __('Add files', BPMJ_EDDCM_DOMAIN) ?>">
    <div class='row'>
        <div class='container'>
            <div class='panel'>
                <div class='panel-body'>
                    ...
                    <div class='form-group'>
                        ...
                        <div
                            class="desc"><?php _e('Write here the title for your new product.', BPMJ_EDDCM_DOMAIN); ?></div>
                    </div>
                    ...
                    <div id='single-price'>
                        <div class='form-group'>
                            ...
                            <input type="number" step="0.01" name="price" id="price"
                                   ...
                                   value="">
                            <div
                                class="desc"><?php _e('How much does your product cost?', BPMJ_EDDCM_DOMAIN); ?></div>
                        </div>
                    </div>
                </div>
            </div>
