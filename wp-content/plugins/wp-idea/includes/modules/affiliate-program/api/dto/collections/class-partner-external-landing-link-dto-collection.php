...
class Partner_External_Landing_Link_DTO_Collection extends Abstract_Iterator
{
    public function add(Partner_External_Landing_Link_DTO $item): self
    {
        return $this->add_item($item);
    }

    public function current(): Partner_External_Landing_Link_DTO
    {
