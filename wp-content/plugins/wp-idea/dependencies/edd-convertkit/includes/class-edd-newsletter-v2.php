...
class EDD_Newsletter_V2 {
	...
	public function render_metabox() {
		...
		echo '<p>' . __( 'Select the lists you wish buyers to be subscribed to when purchasing.', 'edd-convertkit' ) . '</p>';
		...
		if ( $this->allow_unsubscribe ) {
			echo '<p>' . __( 'Select the lists you wish buyers to be unsubscribed from when purchasing.', 'edd-convertkit' ) . '</p>';
