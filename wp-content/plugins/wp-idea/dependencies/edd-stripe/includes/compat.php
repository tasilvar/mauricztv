...
/**
 * A rewritten version of `edd_process_purchase_form()` that allows for true AJAX processing.
 *
 * The Javascript in edd-stripe.js circumvents the `edd_process_purchase_form()` from being called
