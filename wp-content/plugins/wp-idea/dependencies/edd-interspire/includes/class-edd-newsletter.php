...
class EDD_Newsletter {
	...
	public function textdomain() {
		...
		$lang_dir = $lang_dir = dirname( plugin_basename( BPMJ_EDD_IN_DOMAIN ) ) . '/languages/';
	...
	public function checkout_fields() {
		...
		<fieldset id="edd_<?php echo $this->id; ?>">
			<p>
				<input name="edd_<?php echo $this->id; ?>_signup" id="edd_<?php echo $this->id; ?>_signup" type="checkbox" />
