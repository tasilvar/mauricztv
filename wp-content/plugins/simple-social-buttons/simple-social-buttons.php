...
/*
  Copyright 2011, Muhammad Adnan (WPBrigade)  (email : support@wpbrigade.com)
			...
			switch ( $button_name ) {
				...
				case 'fbshare':
					...
					if ( $theme == 'simple-icons' ) {
						$_html .= '		<button class="ssb_fbshare-icon" ' . $ssb_attr_html . ' data-href="https://www.facebook.com/sharer/sharer.php?u=' . $permalink . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<button class="simplesocial-fb-share" ' . $ssb_attr_html . ' data-href="https://www.facebook.com/sharer/sharer.php?u=' . $permalink . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">Facebook </span> ';
				...
				case 'twitter':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<button class="ssb_tweet-icon" ' . $ssb_attr_html . ' data-href="https://twitter.com/intent/tweet?text=' . $title . '&url=' . $permalink . '' . $via . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<button class="simplesocial-twt-share" ' . $ssb_attr_html . ' data-href="https://twitter.com/intent/tweet?text=' . $title . '&url=' . $permalink . '' . $via . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">Twitter</span> ';
				...
				case 'linkedin':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<button class="ssb_linkedin-icon" ' . $ssb_attr_html . ' data-href="' . ssb_linkdin_share_link( $permalink ) . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" >
						...
						$_html = '<button ' . $ssb_attr_html . ' class="simplesocial-linkedin-share" data-href="' . ssb_linkdin_share_link( $permalink ) .'" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">LinkedIn</span>';
				...
				case 'pinterest':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = ' <button class="ssb_pinterest-icon" ' . $ssb_attr_html . ' onclick="var e=document.createElement(\'script\');e.setAttribute(\'type\',\'text/javascript\');e.setAttribute(\'charset\',\'UTF-8\');e.setAttribute(\'src\',\'//assets.pinterest.com/js/pinmarklet.js?r=\'+Math.random()*99999999);document.body.appendChild(e);return false;">
						...
						$_html = '<button class="simplesocial-pinterest-share" ' . $ssb_attr_html . ' onclick="var e=document.createElement(\'script\');e.setAttribute(\'type\',\'text/javascript\');e.setAttribute(\'charset\',\'UTF-8\');e.setAttribute(\'src\',\'//assets.pinterest.com/js/pinmarklet.js?r=\'+Math.random()*99999999);document.body.appendChild(e);return false;" ><span class="simplesocialtxt">Pinterest</span>';
				...
				case 'reddit':
					...
					if ( $theme == 'simple-icons' ) {
						$_html = ' <button class="ssb_reddit-icon" ' . $ssb_attr_html . ' data-href="https://reddit.com/submit?url=' . $permalink . '&title=' . $title . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<button class="simplesocial-reddit-share" ' . $ssb_attr_html . ' data-href="https://reddit.com/submit?url=' . $permalink . '&title=' . $title . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" ><span class="simplesocialtxt">Reddit</span> ';
				...
				case 'whatsapp':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <button  onclick="javascript:window.open(this.dataset.href, \'_blank\' );return false;" class="ssb_whatsapp-icon simplesocial-whatsapp-share" ' . $ssb_attr_html . ' data-href="' . ssb_whats_app_share_link( $permalink ) . '">
						...
						$arrButtonsCode[] = '<button onclick="javascript:window.open(this.dataset.href, \'_blank\' );return false;" class="simplesocial-whatsapp-share" ' . $ssb_attr_html . ' data-href="' . ssb_whats_app_share_link( $permalink ) . '"><span class="simplesocialtxt">WhatsApp</span></button>';
					}
					break;
				case 'viber':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = '<button  onclick="javascript:window.open(this.dataset.href, \'_self\' );return false;" class="simplesocial-viber-share ssb_viber-icon" ' . $ssb_attr_html . ' data-href="' . ssb_viber_share_link($permalink) . '">
						...
						$arrButtonsCode[] = '<button onclick="javascript:window.open(this.dataset.href, \'_self\' );return false;" class="simplesocial-viber-share" ' . $ssb_attr_html . ' data-href="' . ssb_viber_share_link($permalink) . '"><span class="simplesocialtxt">Viber</span></button>';
					}
					break;
				case 'fblike':
				...
				case 'messenger':
					...
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = '<button  onclick="javascript:window.open(this.dataset.href, \'_blank\',  \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\' );return false;" ' . $ssb_attr_html . '  class="simplesocial-viber-share ssb_msng-icon" data-href=' . $messenger_share_url . '>
						...
						$arrButtonsCode[] = '<button class="simplesocial-msng-share" ' . $ssb_attr_html . ' onclick="javascript:window.open( this.dataset.href, \'_blank\',  \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\' );return false;" data-href="' . $messenger_share_url . '" ><span class="simplesocialtxt">Messenger</span></button> ';
					}
					break;
				case 'email':
					...
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <button  onclick="javascript:window.location.href = this.dataset.href;return false;" class="ssb_email-icon simplesocial-email-share" ' . $ssb_attr_html . ' data-href="mailto:?subject=' . $title . '&body=' . $permalink . '">
						...
						$arrButtonsCode[] = '<button onclick="javascript:window.location.href = this.dataset.href;return false;" class="simplesocial-email-share" ' . $ssb_attr_html . '  data-href="mailto:?subject=' . $title . '&body=' . $permalink . '"><span class="simplesocialtxt">Email</span></button>';
					}
					break;
				case 'print':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <button  onclick="javascript:window.print();return false;" class=" ssb_print-icon simplesocial-email-share" ' . $ssb_attr_html . '>
						...
						$arrButtonsCode[] = '<button onclick="javascript:window.print();return false;" ' . $ssb_attr_html . ' class="simplesocial-print-share" ><span class="simplesocialtxt">Print</span></button>';
					}
					break;
				case 'tumblr':
					...
					if ( $theme == 'simple-icons' ) {
						$_html = '<button class="ssb_tumblr-icon" ' . $ssb_attr_html . ' data-href="' . $tumblr_share_url . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<button class="simplesocial-tumblr-share" ' . $ssb_attr_html . ' data-href="' . $tumblr_share_url . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" ><span class="simplesocialtxt">Tumblr</span> ';
