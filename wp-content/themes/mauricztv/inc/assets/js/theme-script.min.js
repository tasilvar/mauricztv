...
//         const date = new Date();
//         date.setTime(date.getTime() + (days * 24 * 60 * 60 * 1000)); // 1 dzień
...
//     const cookieName = "customPopupShown";
//     if (!getCookie(cookieName)) {
//         // Jeśli ciasteczka brak, pokaż popup po 3 sekundach
//         setTimeout(function () {
//             $("#customPopup").fadeIn(); // Pokaż popup
//             $("#backdrop").fadeIn();    // Pokaż backdrop
//         }, 3000);

//         // Ustaw ciasteczko, aby popup nie pokazywał się ponownie
//         setCookie(cookieName, "true", 1);
//     }

//     // Obsługa zamykania popupu po kliknięciu w guzik
//     $("#customClosePopupButton").on("click", function () {
//         $("#customPopup").fadeOut(); // Ukryj popup
//         $("#backdrop").fadeOut();    // Ukryj backdrop
//     });
// });