...
namespace bpmj\wpidea\admin\pages\physical_product_editor\metaboxes;
...
use bpmj\wpidea\admin\pages\physical_product_editor\Physical_Product_Editor_Page_Checker;

class Physical_Product_Metaboxes_Renderer implements Interface_Initiable
{
    private const ADMIN_BODY_CLASSES = 'service-editor';

    private Physical_Product_Editor_Page_Checker $page_checker;
    private Interface_Actions $actions;
    private Interface_Filters $filters;
    private Current_Request $current_request;

    public function __construct(
        Physical_Product_Editor_Page_Checker $page_checker,
    ...
    private function is_product_edit_page(): bool
    {
        ...
        return $this->page_checker->is_physical_product_offer_edit_page(
            $post_id,
            $post_type ?: null,
            $action
        );
