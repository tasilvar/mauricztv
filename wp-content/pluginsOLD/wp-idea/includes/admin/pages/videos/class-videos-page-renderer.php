...
class Videos_Page_Renderer extends Abstract_Page_Renderer
{
    ...
    {
        return $this->view_provider->get_admin('/pages/videos/index', [
            'page_title' => $this->translator->translate('videos.page_title'),
