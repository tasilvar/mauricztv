...
class Course_Lesson_Template extends Abstract_Course_Lesson_Template
{
        ...
        <!-- wp:columns -->
            <div class="wp-block-columns">
                ...
                <!-- wp:column {"width":42.00} -->
                    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42%"> ' . Course_Navigation::get_gutenberg_block_content() . '</div>
                <!-- /wp:column -->
            </div>
        <!-- /wp:columns -->
        <!-- wp:group -->
    ...
    {
        App_View_API_Static_Helper::render_lesson_header();
    }
}
