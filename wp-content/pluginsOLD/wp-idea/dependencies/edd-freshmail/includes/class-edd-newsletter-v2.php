...
class EDD_Newsletter_V2 {
	...
	public function textdomain() {
		...
		$lang_dir = $lang_dir = dirname( plugin_basename( BPMJ_EDDFM_FILE ) ) . '/languages/';;
	...
	public function render_metabox() {
		...
		echo '<p>' . __( 'Select the lists you wish buyers to be subscribed to when purchasing.', BPMJ_EDDFM_DOMAIN ) . '</p>';
		...
		if ( $this->allow_unsubscribe ) {
			echo '<p>' . __( 'Select the lists you wish buyers to be unsubscribed from when purchasing.', BPMJ_EDDFM_DOMAIN ) . '</p>';
