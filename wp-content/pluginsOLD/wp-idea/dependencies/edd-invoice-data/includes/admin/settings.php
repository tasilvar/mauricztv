...
function bpmj_edd_invoice_data_add_settings( $settings ) {
	...
	$edd_invoice_data_settings = array(
		...
		'edd_id_hide_fname'					 => array(
			'id'	 => 'edd_id_hide_fname',
			'name'	 => __( 'Hide firstname field', 'bpmj-edd-invoice-data' ),
			'desc'	 => __( 'When you select this option, EDD firstname field will be hidden', 'bpmj-edd-invoice-data' ),
			'type'	 => 'checkbox'
		),
		'edd_id_hide_lname'					 => array(
			'id'	 => 'edd_id_hide_lname',
			'name'	 => __( 'Hide lastname field', 'bpmj-edd-invoice-data' ),
			'desc'	 => __( 'When you select this option, EDD lastname field will be hidden', 'bpmj-edd-invoice-data' ),
			'type'	 => 'checkbox'
		),
		'edd_id_disable_taxid_verification'	 => array(
			'id'	 => 'edd_id_disable_taxid_verification',
			'name'	 => __( 'Disable Tax ID verification', 'bpmj-edd-invoice-data' ),
			'desc'	 => __( 'When you check this option, the Tax ID verification on the checkout will be disabled', 'bpmj-edd-invoice-data' ),
			'type'	 => 'checkbox'
		),
		'edd_id_enable_receiver'	 => array(
			'id'	 => 'edd_id_enable_receiver',
			'name'	 => __( 'Enable collecting receiver\'s information', 'bpmj-edd-invoice-data' ),
			'desc'	 => __( 'When you check this option, the buyer will be able to optionally specify receiver\'s data', 'bpmj-edd-invoice-data' ),
			'type'	 => 'checkbox'
		),
	);
