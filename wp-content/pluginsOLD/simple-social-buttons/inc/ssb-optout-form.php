...
$pluginSlug = "simple-social-buttons";
$pluginName = "Simple Social Buttons";
$ssb_optout_page_nonce = wp_create_nonce("ssb-optout-nonce");
        ...
        $(function () {
            ...
            function send_optin_request(el, setting_name, setting_option_value) {
                $.ajax({
                    ...
                    data: {
                        action: 'ssb_optout_yes',  // The action to trigger
                        setting_name: setting_name,  // The setting name (option)
                        setting_value: setting_option_value,  // The value (opt-in or opt-out)
                        security: '<?php echo isset($ssb_optout_page_nonce) ? $ssb_optout_page_nonce : ''; ?>',  // Security nonce
                    },
                    beforeSend: function () {
